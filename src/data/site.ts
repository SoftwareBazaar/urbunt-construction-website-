...
export const projects: Project[] = [
  ...
  },
  {
    ...
    year: 2025,
    duration: "7 months (completed)",
    budget: "KSh 42M",
    image: "karen",
    brief: "A luxurious 2-storey family residence featuring ornamental Roman columns, curved architectural staircase with elegant arches, decorative metalwork railings, and premium interior finishes. Project includes structural works with engineered foundation, reinforced concrete columns and beams, decorative external facade with classical column details, and sophisticated interior spaces with curved staircase design. Successfully completed ahead of schedule with exceptional attention to architectural detail.",
    trades: ["architecture-design", "masonry", "carpentry", "roofing", "plumbing", "electrical", "plastering-ceilings", "painting-decor", "flooring", "smart-security"],
    testimonial: { quote: "Urban T Construction transformed our vision into reality. The attention to architectural detail and quality of execution is outstanding.", author: "Private Client, Karen", role: "Homeowner" },
  },
  {
