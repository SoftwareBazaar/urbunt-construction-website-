-- =====================================================
-- Collins Njoroge Project - Complete Setup
-- =====================================================
-- This creates a placeholder client account and the full project
-- Run this entire file in Supabase SQL Editor

-- =====================================================
-- STEP 1: Create Placeholder Client Account
-- =====================================================
-- We'll create a user entry that Collins can claim later
-- Or you can update with his real email when he signs up
...
BEGIN
  ...
  FROM auth.users
  WHERE email = 'collins.placeholder@urbantconstruction.com';

  -- If not exists, create it
  IF placeholder_user_id IS NULL THEN
    -- Insert into auth.users (using Supabase auth system)
    INSERT INTO auth.users (
      ...
      'a1b2c3d4-0000-0000-0000-collins00001'::uuid,
      'authenticated',
      'authenticated',
      'collins.placeholder@urbantconstruction.com',
      crypt('temporary-password-change-later', gen_salt('bf')),
      now(),
      now(),
      now(),
    ...
    RAISE NOTICE '✅ Created placeholder user for Collins';
  ELSE
    RAISE NOTICE '✅ Placeholder user already exists';
  END IF;
END $$;
...
INSERT INTO client_projects (
  ...
  'a1b2c3d4-0000-0000-0000-collins00001'::uuid, -- Placeholder user ID
...
-- =====================================================
-- STEP 4: Detailed Work Schedule (Daily Progress Updates)
-- =====================================================
...
BEGIN
  ...
  RAISE NOTICE '   Client: Collins Njoroge (Placeholder account)';
  RAISE NOTICE '   Location: Murang''a, Kenya';
  RAISE NOTICE '   Duration: 90 days (3 months)';
  RAISE NOTICE '   Size: 108 sq.m ground floor';
  RAISE NOTICE '';
  RAISE NOTICE '✅ Created: Placeholder client account';
  RAISE NOTICE '✅ Created: Project record';
  RAISE NOTICE '✅ Created: 10 Milestones';
  RAISE NOTICE '✅ Created: 14 Daily Task Updates';
  RAISE NOTICE '';
  RAISE NOTICE '🎯 Next Steps:';
  RAISE NOTICE '   1. Go to /admin/projects - Collins project is ready!';
  RAISE NOTICE '   2. Add progress photos at /admin/media';
  RAISE NOTICE '   3. Update milestones as work progresses';
  RAISE NOTICE '';
  RAISE NOTICE '👤 When Collins Creates Real Account:';
  RAISE NOTICE '   Option A: Ask Collins to sign up at /auth with his real email';
  RAISE NOTICE '   Option B: Update placeholder email in admin panel';
  RAISE NOTICE '';
  RAISE NOTICE '📧 Current Placeholder Email:';
  RAISE NOTICE '   collins.placeholder@urbantconstruction.com';
  RAISE NOTICE '   (Change this to his real email in /admin/users)';
  RAISE NOTICE '';
